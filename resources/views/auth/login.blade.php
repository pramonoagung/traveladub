                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-8 col-sm-offset-2 text">
                                    <h1>
                                        <a href="/"><img src="tl.png" alt="TraveLadub"
                                ...
                                <div class="col-sm-6 col-sm-offset-3 form-box">
                                    <div class="form-top">
                                        <div class="form-top-left">
                                            <h2><strong>Masuk</strong> ke TRAVELADUB</h2>
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <p style="color: white">
                                        Belum punya akun? <a href="/register" class="text-default m-l-5"><b>Daftar sekarang!</b></a>
                                    </p>
                                </div>
                            </div>
                        </div>
