         ...
         <div class="gl-elements-content-wrapper">
            ...
            <div class="gl-directory-searchbar gl-bz-directory-searchbar">
               <form action="#" id="gl-bz-directory-form">
                  <fieldset>
                     <input type="text" style="width: 100%" name="search" id="gl-search-location"
   ...
   <div class="container">
      <div class="row">
         <div class="gl-custom-sec-content">
            ...
            <p>Untuk mengetahui apa itu TraveLadub dan bagaimana cara kerjanya pengunjung bisa membuka halaman Frequently Asked Question (FAQ) dengan menekan tombol dibawah ini. 
            </p>
   ...
   <div class="container-fluid">
      <div class="row">
         <div class="gl-custom-image-wrapper">
            <img src="assets/images/xcustom-img-1.jpg.pagespeed.ic.9QLOsACqJY.jpg" alt="Custom Image" class="gl-lazy">
         </div>
      </div>
   </div>
</section>
